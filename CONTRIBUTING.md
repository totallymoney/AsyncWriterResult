# Contributing to AsyncWriterResult
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/AsyncWriterResult
   # Navigate to the newly cloned directory
   cd AsyncWriterResult
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/<project-username>/AsyncWriterResult
   ```
