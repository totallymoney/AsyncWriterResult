...
let tests =
    testList "List"
        [ test "traverseWriterA should keep all logs" {
            let input =
                [ 1, createWriter 1 [1; 2]
                  2, createWriter 2 [2; 3] ]

            let actualItem, actualLogs =
                List.traverseWriterA snd input
                |> Writer.run
          ...
          test "traverseWriterA should maintain log order" {
            let input =
                [ 1, createWriter 1 [11; 12; 13; 00]
                  2, createWriter 2 [21; 22; 23; 00] ]
